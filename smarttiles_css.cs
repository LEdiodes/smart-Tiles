...
.footer {color: #FF0000;} /* Footer is the text at the bottom of the tiles and includes the thermometer icon for Temperature tiles */
...
.icon.Home i::before {content: "Home";} /* Although all you see is a box here, this is actually a Font Awesome icon. You can put any Font Awesome icon from the cheatsheet in here and have it displayed. It goes in between the 2 sets of double quotes. */
...
.link .icon {color: #D7A22A;} /* This will change the icon color for external weblinks. */
 
/* Refresh */
.tile.refresh {background-color: white;} /* This will change the background color for the Refresh tile. */
.refresh .icon {color: #D7A22A;} /* This will change the icon color for the Refresh tile. */
.refresh .fa {color: #D7A22A;} /* This will change the Font Awesome icon color for the Refresh tile. */
